---
name: dovik
description: Use ordinary GitHub CLI commands and available process lifecycle tools while keeping workstation routing transparent for Claude Code.
metadata:
  version: "1.0.0"
---
...
1. Run ordinary `gh` exactly as requested. Treat its stdout, stderr, help, version, and exit code as the GitHub CLI interface. Do not inspect identity routing before or after a successful command.
